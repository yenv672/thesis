...
namespace Invector.CharacterController
{
    ...
    {	
	    ...
	    ThirdPersonAnimator tpController;
	    Animator animator;
	    ...
	    {	
            ...
            tpController.tpCamera.offSetPlayerPivot = 0f;
            tpController.tpCamera.SetTarget(characterHips);
	    ...
	    IEnumerator ResetPlayer(float waitTime) 
	    {
            ...
            tpController.tpCamera.offSetPlayerPivot = tpController.offSetPivot;
            tpController.tpCamera.SetTarget(this.transform);
