...
namespace Invector.CharacterController_2
{
//    [RequireComponent(typeof(Rigidbody))]
//    [RequireComponent(typeof(CapsuleCollider))]

    public class ThirdPersonController_2 : ThirdPersonAnimator
    {
        private static ThirdPersonController_2 _instance;
        public static ThirdPersonController_2 instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = GameObject.FindObjectOfType<ThirdPersonController_2>();
...
//                    canSprint = true;
//                if (CrossPlatformInputManager.GetButtonUp("RB") || currentStamina <= 0 || input.sqrMagnitude < 0.1f || aiming)
//                    canSprint = false;
//            }
//            else
//            {
...
//            if (inputType == InputType.Mobile)
//            {
//                if (CrossPlatformInputManager.GetButtonDown("A") && !actions || triggerAction.autoAction && !actions)
//                {
